...
export const policyGuidance = {
  id: "policy",
  selectionText: "Develop or update a policy/standard",
  steps: [
    "Fake Step"
  ],
  optionsState: {
  ...
  return (
    <div className={classes.stepContainer}>
      <div style={{ margin: "12px 24px" }}>
        <p style={{ margin: 0 }}><b>Use Case: </b><i>{policyGuidance.selectionText}</i></p>
...
function PolicyGuidance({ activeStep, options, handleOptionsChange, data, selectedLocation }) {
  switch (activeStep) {
  case 1:
    return <Step2
      options={options}
